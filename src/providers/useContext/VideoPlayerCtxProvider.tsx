...
import {
  TVideoCropAreaReducerActions,
  videoCropAreaReducer,
} from "@/providers/useContext/reducers/videoCropArea";
import {
  videoPlayerStateReducer,
  TVideoPlayerStateReducerActions,
} from "@/providers/useContext/reducers/videoPlayerState";
...
export type TDispatchVideoPlayerStateCtx =
  null | React.Dispatch<TVideoPlayerStateReducerActions>;

export type TDispatchVideoCropAreaCtx =
  null | React.Dispatch<TVideoCropAreaReducerActions>;
