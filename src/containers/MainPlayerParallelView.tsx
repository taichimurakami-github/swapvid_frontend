...
import DocumentOverviewContainer from "@/_old_containers/DocumentOverviewContainer";
import DocumentPlayerParallelContainer from "@/_old_containers/DocumentPlayerParallelLocalContainer";
    ...
    <div className="parallel-view-container flex-xyc gap-8">
      <div className="video-player-container">
        <div className="relative max-w-[1440px] z-0 w-[1fr]">
          ...
          {videoRef.current && <VideoSubtitles />}
        </div>
